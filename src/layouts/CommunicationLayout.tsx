...
export default function CommunicationLayout() {
  ...
  const sidebarProps = { isOpen: isSidebarOpen, onClose: toggleSidebar, onLogout: handleLogout };
  ...
  return (
    <>
      ...
      <main style={{ marginTop: "72px", padding: "30px", width: "100%", minHeight: "100vh", background: "#f8fafb", boxSizing: "border-box" }}>
        <Outlet />
      </main>
    </>
  );
